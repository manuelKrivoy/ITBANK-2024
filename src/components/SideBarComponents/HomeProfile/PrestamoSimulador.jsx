      ...
      <CardContent>
        ...
        <Box sx={{ marginBottom: 3 }}>
          ...
          <Box sx={{ border: "1px solid #ccc", padding: 2, borderRadius: 2, marginTop: 2 }}>
            ...
            <Typography variant="h4" sx={{ color: "#614aff", fontWeight: "bold" }}>
              TASA DE INTERÉS: 84.00% NAV 125.22% EAV
            </Typography>
          </Box>
        </Box>
        <Box>
          <Typography variant="h6">Obtené tu préstamo completando el siguiente formulario.</Typography>
          <Button variant="contained" sx={{ marginTop: 2, backgroundColor: "#614aff" }}>
            Mi préstamo
          </Button>
        </Box>
      </CardContent>
