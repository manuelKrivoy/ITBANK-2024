...
import { TextField, Button, Typography, Container, Card, CardContent, MenuItem } from "@mui/material";
  ...
  const convertCurrency = async () => {
    try {
      const response = await axios.get(
        `https://v6.exchangerate-api.com/v6/1871b26c2559f77b0a6cd4a5/latest/${fromCurrency}`
      );
